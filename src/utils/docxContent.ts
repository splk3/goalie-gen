 ...
 * - Footer: "Generated by Goalie Gen" (grey) + right-aligned page number in
 *   secondaryColor, with a secondaryColor border line above.
 *
...
export function makeDocxHeaderFooter(
  ...
  const { Header, Footer, BorderStyle, TabStopType, PageNumber, Paragraph, TextRun, AlignmentType } =
    classes;
