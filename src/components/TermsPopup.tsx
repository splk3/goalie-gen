    ...
    <>
      ...
      >
        ...
        <div className="px-8 pt-8 pb-4 flex-shrink-0">
          <h2
            id="terms-heading"
            className="text-3xl font-bold text-usa-blue dark:text-blue-400 mb-2"
          >
            Terms of Use
          </h2>
        ...
        {/* Scrollable content — the close button below is always visible */}
        <div className="px-8 pr-4 overflow-y-auto flex-1 min-h-0 space-y-6 text-gray-700 dark:text-gray-300">
          {/* Acceptance of Terms */}
          <section>
            ...
            <p className="mb-2">
              By accessing and using Goalie Gen (the &quot;Site&quot;), you acknowledge that you
              have read, understood, and agree to be bound by these Terms of Use. Your use of the
              Site constitutes your acceptance of these terms. If you do not agree to these terms,
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              hockey goaltending development. All content, plans, drills, and materials are provided
          ...
          <section>
            ...
            <p className="mb-2">
              <strong className="text-usa-red dark:text-red-400">
                YOU ARE SOLELY RESPONSIBLE FOR YOUR USE OF THE SITE AND ALL INFORMATION, PLANS, AND
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                You are responsible for verifying that any training plans or drills are appropriate
                for the skill level, age, and physical condition of participants.
              </li>
              <li>
              ...
              <li>You assume all risks associated with the use of information from this Site.</li>
              <li>
                The Site operators are not responsible for any injuries, damages, or losses that may
                result from your use or misuse of the information provided.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              The content on this Site does not constitute professional coaching, medical, or legal
              advice. The Site is not a substitute for professional consultation with qualified
              coaches, trainers, or medical professionals. Always seek the advice of qualified
              professionals regarding athletic training, injury prevention, and player development.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              The Site and all content, materials, and tools are provided on an &quot;AS-IS&quot;
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              USE, GOODWILL, OR OTHER INTANGIBLE LOSSES RESULTING FROM YOUR USE OF THE SITE OR ANY
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              the Site. You may not use the Site in any way that could damage, disable, overburden,
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              and software, is the property of Patrick Boyle, Katie Jablynski, and James Kujawski
              and of their respective content suppliers. This content is protected by copyright and
              other intellectual property laws. The content is provided for your personal,
          ...
          <section>
            ...
            <p className="mb-3">Your use of the Site is also governed by our privacy practices:</p>
        ...
        <div className="px-8 py-6 flex justify-end flex-shrink-0">
          <button
            onClick={closeTerms}
