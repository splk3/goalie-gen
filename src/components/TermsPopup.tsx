            ...
            <div className="max-h-[60vh] overflow-y-auto pr-4 space-y-6 text-gray-700 dark:text-gray-300">
              ...
              <section>
                ...
                <p className="mb-2">
                  ...
                  have read, understood, and agree to be bound by these Terms of Use. Your use of
                  the Site constitutes your acceptance of these terms. If you do not agree to these
              ...
              <section>
                ...
                <p className="mb-2">
                  <strong className="text-usa-red dark:text-red-400">
                    YOU ARE SOLELY RESPONSIBLE FOR YOUR USE OF THE SITE AND ALL INFORMATION, PLANS,
                    AND RESOURCES OBTAINED FROM IT.
                  </strong>
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    The Site operators are not responsible for any injuries, damages, or losses that
              ...
              <section>
                ...
                <p className="mb-2">
                  The Site and all content, materials, and tools are provided on an
              ...
              <section>
                ...
                <p className="mb-2">
                  TO THE FULLEST EXTENT PERMITTED BY LAW, THE SITE OPERATORS SHALL NOT BE LIABLE FOR
              ...
              <section>
                ...
                <p className="mb-2">
                  ...
                  of the Site. You may not use the Site in any way that could damage, disable,
                  overburden, or impair the Site or interfere with any other party&apos;s use of the
                  Site.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-2">
                  ...
                  images, and software, is the property of Patrick Boyle, Katie Jablynski, and James
                  Kujawski and of their respective content suppliers. This content is protected by
                  copyright and other intellectual property laws. The content is provided for your
              ...
              <section>
                ...
                <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                  ...
                  <p className="mb-2">
                    ...
                    individual player names, contact details, or other direct personal identifiers
                    are recorded.
                  </p>
