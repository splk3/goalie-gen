...
export default function BackLinkButton({ to, children, className = "" }: BackLinkButtonProps) {
  const baseClasses =
    "inline-flex w-full max-w-full items-center justify-center gap-2 rounded-lg bg-usa-blue px-4 py-3 text-center font-bold text-white transition-colors hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 sm:w-auto sm:px-6";
